...
export SPARK_COMMON_OPTS="$SPARK_COMMON_OPTS -Dspark.kryoserializer.buffer.mb=32 -Djava.io.tmpdir=/srv/spark/tmp "
export SPARK_MASTER_OPTS=" -Dspark.deploy.defaultCores=2 -Dspark.local.dir=/srv/spark/master -Dspark.log.file=/srv/spark/log/master.log "
export SPARK_WORKER_OPTS=" -Dspark.local.dir=/srv/spark/tmp/worker -Dspark.log.file=/srv/spark/log/worker.log "
